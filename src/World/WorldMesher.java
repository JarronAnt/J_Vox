...
//this is the class that creates our mesh for each chunk in the world
//uses a greedy meshing algorithim
public class WorldMesher {
    ...
    public Model loadModel() {
        return J_Vox.modelLoader.loadToVAO(positionsArray, indicesArray, colorsArray);
    }

    //the greeding meshing algorithim...its complicated
    void greedy() {
        /*
